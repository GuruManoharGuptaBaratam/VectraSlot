    ...
    return (
        <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(46,196,182,0.2),_transparent_30%),radial-gradient(circle_at_top_right,_rgba(255,107,53,0.18),_transparent_32%),linear-gradient(180deg,_#f2e9dc_0%,_#fcfaf6_38%,_#eef6f7_100%)] px-4 py-6 font-body text-ink sm:px-6 lg:px-8">
            ...
            <section className="relative mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-7xl flex-col justify-center gap-10">
                <header className="flex items-center justify-between gap-4 rounded-full border border-white/60 bg-white/70 px-4 py-3 shadow-card backdrop-blur">
                    <div>
                ...
                <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <Link
                                to="/signup"
                                className="rounded-full bg-flare px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-flare/25 transition hover:-translate-y-0.5 hover:bg-orange-600"
                            >
                                Get started
                            </Link>
                            <Link
                                to="/login"
                                className="rounded-full border border-slate-300 bg-white/80 px-6 py-3 text-sm font-semibold text-ink transition hover:border-ocean/30 hover:bg-white"
                            >
                        ...
                        <div className="grid gap-3 sm:grid-cols-3">
                            {[
                                ...
                                <article key={title} className="rounded-3xl border border-white/70 bg-white/70 p-4 shadow-sm backdrop-blur">
                    ...
                    <div className="relative">
                        <div className="absolute -left-8 top-8 h-28 w-28 rounded-full bg-mint/25 blur-3xl" />
                        <div className="absolute bottom-10 right-4 h-36 w-36 rounded-full bg-flare/20 blur-3xl" />

                        <article className="relative rounded-[2rem] border border-white/70 bg-[#0b1b29]/92 p-6 text-white shadow-card backdrop-blur">
                            <div className="flex items-center justify-between gap-3">
                                <div>
                                    <p className="text-xs uppercase tracking-[0.22em] text-mint/80">Live workspace</p>
                                    <h2 className="mt-2 font-heading text-2xl font-semibold">Role aware by design</h2>
                                </div>
                            ...
                            <div className="mt-6 grid gap-3 rounded-2xl border border-mint/20 bg-mint/10 p-4 sm:grid-cols-2">
                                <div>
                                    <p className="text-xs uppercase tracking-[0.2em] text-mint/80">User path</p>
                                    <p className="mt-1 text-sm text-slate-200">Book a slot, review your reservations, manage your time window.</p>
                                </div>
                                <div>
                                    <p className="text-xs uppercase tracking-[0.2em] text-flare/80">Admin path</p>
                                    <p className="mt-1 text-sm text-slate-200">Manage users, slots, bookings, and system metrics.</p>
                                </div>
                            </div>
                        </article>
                    </div>
